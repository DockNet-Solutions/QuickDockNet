...
<div class="overlay changepwd__container">
    ...
    <script>
        function sendChangePass() {
            ...
            if(new_password.length < 64 && new_password.length >= 12 && new_password2.length < 64 && new_password2.length >= 12 && old_password.length < 64 && old_password.length > 0 && new_password.value === new_password2.value) {
